...
public class GooglePlaces {
    ...
    public static String PHOTO_URL = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=1500&photoreference=&sensor=true&key="+API_KEY;
	public ArrayList<Placeresponse> findPlaces(double latitude,
	...
	public PlaceDetailModel GetPlacesDetails(String referenceString) {
		String url = PLACES_DETAILS_URL;
		StringBuilder builder = new StringBuilder(url);
		builder.append("reference=").append(referenceString)
				.append("&sensor=true").append("&key=" + API_KEY);
		JSONObject array = null;
		
		try {
		String detailsurl = builder.toString();
		JSONObject object = getJSON(detailsurl);
		if (object == null)
			return null;
		
			array = object.getJSONObject("result");
		...
		return model.JsontoPlaceModel(array);
	}

	private String createSearchQueryString(double latitude, double longitude,
			String place) {
